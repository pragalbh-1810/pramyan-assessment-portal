...
$p1 = $skillStats['P1']['total'] > 0 
    ? round(($skillStats['P1']['score'] / $skillStats['P1']['total']) * 100, 2) 
    : 0;

$p2 = $skillStats['P2']['total'] > 0 
    ? round(($skillStats['P2']['score'] / $skillStats['P2']['total']) * 100, 2) 
    : 0;

$p3 = $skillStats['P3']['total'] > 0 
    ? round(($skillStats['P3']['score'] / $skillStats['P3']['total']) * 100, 2) 
    : 0;
...
$stmt->execute([
    $student_test_id, $total, $math, $sci, $overall_pct, 
    $p1, $p2, $p3, $action_plan
]);
