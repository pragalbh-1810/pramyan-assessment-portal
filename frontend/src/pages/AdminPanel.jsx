  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#EEF4FF] font-['Sora',sans-serif] pb-[80px] md:pb-8">
        ...
        {toast && (
          <div
            className={`fixed top-20 md:top-24 right-3 md:right-6 z-50 anim-pop max-w-[340px] flex items-start gap-2.5 px-4 py-3 rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.12)] ${toast.type === "ok" ? "bg-[#e6f7f1] border-[1.5px] border-[#a7e6cc] text-[#1D9E75]" : "bg-[#fff0f0] border-[1.5px] border-[#ffd4d4] text-[#e24b4a]"}`}>
            {toast.type === "ok" ? (
              <CheckCircle2
                size={16}
                strokeWidth={2.25}
            ...
            {teachers.map((t) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2.5 p-3 rounded-xl border-2 transition-all text-left ${active ? "border-[#185FA5] bg-[#EEF4FF]" : "border-[#e2edf8] bg-[#f8fbff] hover:border-[#a8c4e8]"}`}>
    ...
    return (
      <div className="anim-fade-up">
        <button
          ...
          className="flex items-center gap-1.5 text-[#185FA5] text-[13px] font-semibold cursor-pointer active:scale-95 transition mb-5 bg-white px-4 py-2 rounded-xl border border-[#d4e4f7] shadow-sm w-fit hover:bg-[#f8fbff]">
        ...
        {reportLoading ? (
          ...
          report && (
            <FormatReport
              ...
              teacherName={teacherById[activeStudent.assigned_teacher_id]?.name}
            />
          )
        )}
      </div>
  ...
  return (
    <div className="pb-10">
      ...
      <div className="bg-[linear-gradient(135deg,#1D9E75_0%,#185FA5_100%)] rounded-3xl p-6 md:p-8 mb-6 shadow-[0_8px_32px_rgba(24,95,165,0.2)] flex flex-col md:flex-row md:items-center md:justify-between gap-5">
        <div className="flex flex-col gap-1">
          ...
          <span className="text-xs text-white/70 font-['Inter',sans-serif]">
            Admin View — All Sections Unlocked
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-white rounded-[18px] p-6 shadow-[0_4px_16px_rgba(24,95,165,0.05)] border border-[#e2edf8]">
          ...
          <div className="flex items-center justify-between text-[11px] text-[#aaa] font-['DM_Sans',sans-serif]">
            ...
            <span
              ...
              style={{ background: mathSt.bg, color: mathSt.color }}>
              {mathSt.label}
            </span>
          </div>
        </div>
        <div className="bg-white rounded-[18px] p-6 shadow-[0_4px_16px_rgba(24,95,165,0.05)] border border-[#e2edf8]">
          ...
          <div className="flex items-center justify-between text-[11px] text-[#aaa] font-['DM_Sans',sans-serif]">
            ...
            <span
              className="text-[11px] font-semibold px-2.5 py-[3px] rounded-full"
              style={{ background: sciSt.bg, color: sciSt.color }}>
              {sciSt.label}
            </span>
          </div>
        </div>
      ...
      <div className="bg-white border border-[#e2edf8] rounded-[20px] p-5 md:p-10 mb-6 shadow-[0_4px_24px_rgba(24,95,165,0.06)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <SwotBox
            ...
            items={swot.threats.map((t) => ({ chapter: t, label: t }))}
              ...
              return (
                <div
                  ...
                  <div
                    ...
                    style={{ width: `${pct}%`, background: levelObj.barColor }}>
                    {pct}%
                  </div>
                </div>
              );
      ...
      {activeReport.chapter_scores?.length > 0 ? (
        ...
        <div className="bg-white rounded-[20px] p-10 mb-8 text-center text-[#888] border border-[#e2edf8]">
          No Chapter Analysis data available.
        </div>
      )}
      ...
      <div className="bg-white rounded-[20px] p-5 md:p-10 shadow-[0_4px_24px_rgba(24,95,165,0.06)] border border-[#e2edf8] mb-8">
        ...
        <div className="text-[13px] md:text-sm text-[#444] mb-5 leading-relaxed font-['Inter',sans-serif]">
          Detailed question-by-question breakdown mapped to skills and cognitive
          levels.
        </div>
        <div className="overflow-x-auto -mx-2 px-2">
